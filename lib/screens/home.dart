...
import 'package:myuber2/screens/razorpay.dart';
import 'package:myuber2/widgets/mover_list.dart';
      ...
      child: Scaffold(
          ...
          children: [
            UserAccountsDrawerHeader(
                accountName: CustomText(
                  text: userProvider.userModel?.name ?? appState.idxStr,
                  size: 18,
            ...
            ListTile(
              ...
              onTap: () {
                ...
                changeScreenReplacement(context, LoginScreens());
                // pushNamedAndRemoveUntil(context, LoginScreens());
              },
            )
          ],
        )),
        body: Stack(
          children: [
            ...
            Visibility(
                visible: appState.idxStr == "0",
                child: DestinationSelectionWidget()),
              
            // ANCHOR PICK UP WIDGET
            Visibility(
                visible: appState.idxStr == "2",
                child: MyApp()),
            
            Visibility(
              visible: appState.idxStr == "1",
