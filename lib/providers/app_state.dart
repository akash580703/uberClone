...
// ANCHOR: MAPS & LOCATION METHODS
  ...
  Future sendRequest({LatLng origin, LatLng destination}) async {
    ...
    if (origin == null) {
      ridePrice =
          double.parse((routeModel.distance.value* 0.013).toStringAsFixed(0));
      ridePrice2 =
          double.parse((routeModel.distance.value * 0.015).toStringAsFixed(0));
      ridePrice3 =
          double.parse((routeModel.distance.value * 0.017).toStringAsFixed(0));
      ridePrice4 =
          double.parse((routeModel.distance.value * 0.020).toStringAsFixed(0)); 
